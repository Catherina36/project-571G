...
const ProgramDetails = () => {
  ...
  const fetchDonators = async () => {
    ...
    const data = await getDonations(state.owner, state.index);
    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        <div className="flex-1 flex-col">
          ...
          <div className="relative w-full h-[5px] bg-[#e9f0f7] mt-2">
          ...
          <div>
            ...
            <div className="mt-[20px] flex flex-row items-center flex-wrap gap-[14px]">
              ...
              <div>
                ...
                <p className="mt-[4px] font-epilogue font-normal text-[12px] text-[#808191]">10 Programs</p>
              </div>
            </div>
          </div>
      ...
      <div className="flex-[2] flex flex-col gap-[40px]">
        <div>
            <h4 className="font-epilogue font-semibold text-[18px] text-black uppercase">Active program</h4>

            <div className="mt-[20px]">
              <p className="font-epilogue font-normal text-[16px] text-[#808191] leading-[26px] text-justify">{state.active.toString()}</p>
            </div>
        </div>
        ...
        <div className="flex-1">
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#e9f0f7] rounded-[10px]">
            ...
            <div className="mt-[30px]">
              ...
              <div className="my-[20px] p-4 bg-[#e9f0f7] rounded-[10px]">
